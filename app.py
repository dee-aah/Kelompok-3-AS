...
MODEL_PATH = "models/linear_svc.pkl"
TFIDF_PATH = "models/tfidf_vectorizer_3k.pkl"
...
def highlight(val):
    ...
    if val == "Toxic":
        return "background-color:#DC0000;font-weight:bold"
    return "background-color:#08CB00;font-weight:bold"

st.set_page_config(page_title="YouTube Spam Detector", layout="wide")
st.title("YouTube Live & Post Live Spam Detector")
st.write("Deteksi **Spam dan Toxic** dari live chat YouTube dan tetap bisa dianalisis setelah live selesai.")
...
toxic = (st.session_state.all_comments["Prediksi"] == "Toxic").sum()
